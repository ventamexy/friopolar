...
//   var seccion3 = $("#seccion3").offset().top;
//   var seccion4 = $("#seccion4").offset().top;
//
...
//     $("html, body").animate({scrollTop: $("#seccion2").offset().top}, 500);
//   });
//
//   $(".trabajos").click(function() {
//     $("html, body").animate({scrollTop: $("#seccion3").offset().top}, 500);
//   });
//
//   $(".contacto").click(function() {
//     $("html, body").animate({scrollTop: $("#seccio4").offset().top}, 500);
//   });
